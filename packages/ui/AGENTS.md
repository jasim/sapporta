...
The UI must provide maximum visibility into what the system is doing. Loading states should say *what* is being loaded, not just show a spinner. Error states should explain: what the UI was trying to do, what happened, and the exact error message from the server.
