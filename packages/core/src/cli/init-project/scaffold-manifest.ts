...
export const SCAFFOLD_MANIFEST: ScaffoldManifest = [
  ...
  scaffoldFileAt("mailer.ts", "packages/api/mailer.ts", "framework"),
  ...
  scaffoldFileAt(
    "project-auth/index.ts",
    "packages/api/project-auth/index.ts",
    "framework",
  ),
  scaffoldFileAt(
    "project-auth/better-auth.ts",
    "packages/api/project-auth/better-auth.ts",
    "framework",
  ),
  scaffoldFileAt(
    "project-auth/emails.ts",
    "packages/api/project-auth/emails.ts",
    "framework",
  ),
  scaffoldFileAt(
  ...
  scaffoldFileAt(
    ...
    "packages/api/project-auth/context.ts",
    "framework",
  ),
  scaffoldFileAt(
    "project-auth/auth-tokens.ts",
    "packages/api/project-auth/auth-tokens.ts",
    "framework",
  ),
  scaffoldFileAt(
    "project-auth/workspace.ts",
    "packages/api/project-auth/workspace.ts",
    "framework",
  ),
  scaffoldFileAt(
    "project-auth/routes.ts",
    "packages/api/project-auth/routes.ts",
    "framework",
  ),
  scaffoldFileAt(
    "project-auth/schema.ts",
    "packages/api/project-auth/schema.ts",
    "framework",
  ),
  scaffoldFileAt(
    "project-auth/env.ts",
    "packages/api/project-auth/env.ts",
    "framework",
  ),
  scaffoldFileAt(
    "project-auth/middleware.ts",
    "packages/api/project-auth/middleware.ts",
    "framework",
  ),
  scaffoldFileAt(
    "project-auth/errors.ts",
    "packages/api/project-auth/errors.ts",
    "framework",
  ),
