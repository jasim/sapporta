...
- 49c266a: The SQLite database of a Sapporta app is now located by the
...
- Release
- de763ef: `projectRoot()`, `projectPath()`, and `dataPath()` now work at the top of a
