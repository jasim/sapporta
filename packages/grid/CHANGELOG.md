...
- fa399dc: The grid's sizing can be tuned from an app's stylesheet and its column widths
  from props.
...
- Release
- e905f48: `NumericCell` paints `colorRule: "negative"` and negative `signed` values with
