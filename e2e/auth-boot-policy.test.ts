...
function writeBootReadySchema(projectDir: string): void {
  writeSchemaFile(
    ...
    [
      ...
      "});",
      "",
      "export const bootReadyTasks = table({",
      "  drizzle: bootReadyTasksTable,",
      '  meta: { label: "Boot Ready Tasks", rowScope: "workspaceUserScoped" },',
      "});",
      "",
...
function writeInvalidAuthSchema(projectDir: string): void {
  writeSchemaFile(
    ...
    [
      ...
      "});",
      "export const bootMissingWorkspace = table({",
      "  drizzle: bootMissingWorkspaceTable,",
      '  meta: { label: "Missing Workspace", rowScope: "workspaceGlobal" },',
      "});",
      "",
      ...
      '  workspace_id: text("workspace_id").notNull(),',
      "});",
      "export const bootMissingUserScope = table({",
      "  drizzle: bootMissingUserScopeTable,",
      '  meta: { label: "Missing User Scope", rowScope: "workspaceUserScoped" },',
      "});",
      "",
      ...
      '  name: text("name").notNull(),',
      "});",
      "export const bootInvalidScope = table({",
      "  drizzle: bootInvalidScopeTable,",
      '  meta: { label: "Invalid Scope", rowScope: "tenantScoped" as never },',
      "});",
      "",
      ...
      '  workspace_id: text("workspace_id").notNull(),',
      "});",
      "export const bootUnregisteredRef = table({",
      ...
      '  workspace_id: text("workspace_id").notNull(),',
      "});",
      "export const bootReferenceTarget = table({",
      "  drizzle: bootReferenceTargetTable,",
      '  meta: { label: "Reference Target", rowScope: "workspaceGlobal" },',
      "});",
      "",
      ...
      '  workspace_id: text("workspace_id").notNull(),',
      "});",
      "export const bootUnknownSourceRef = table({",
      ...
      '  workspace_id: text("workspace_id").notNull(),',
      "});",
      "export const bootUnknownProtectedRef = table({",
